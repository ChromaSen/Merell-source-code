...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Kevin', 'kevin_icon', 'V2 Programmer', 'https://kevinkuntz.newgrounds.com/', 'EFB0A1'],
			['chromasen', 'chromasen icon', 'V2 Programmer', 'https://www.youtube.com/channel/UCJQ1TgCbopgMSoqnWVifdzg', '6D5E78'],
			...
			['Matt Money', 'matt icon', 'Composer for Funky Feline, Nitrous, and 404d, owner of Cyrix', 'https://twitter.com/matt_currency', '86F078'],
	...
	override function update(elapsed:Float)
	{
		...
		if(!quitting)
		{
			...
			if(controls.ACCEPT) {
				if (creditsStuff[curSelected][3] != '') CoolUtil.browserLoad(creditsStuff[curSelected][3]);
			}
			if (controls.BACK)
			{
				if(colorTween != null) {
	...
	function getCurrentBGColor() {
		...
		if (creditsStuff[curSelected][4] == '0') return 0 else return Std.parseInt(bgColor);
	}
