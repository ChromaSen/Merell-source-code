...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Formula",		"Beat Merell on Hard with no Misses.",				'merell_nomiss',			 false],
		...
		["Circuit Breaker",		"Beat Merell's Week on Hard with no Misses.",				'weekM_nomiss',			 false],
		...
		["Trashed and Scattered",		"Beat Click-tick's Week on Hard with no Misses.",				'weekCT_nomiss',			 false],
